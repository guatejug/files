	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			...
			<div class="carousel-caption">
				...
				<div class="buttons wow fadeInDown" data-wow-delay="0.2s"><a class="btn btn-lg btn-border" href="about.html">¿Que es Java Day?</a></div>
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<h2 class="wow fadeInDown" data-wow-delay="300ms">¿Te gustaria compartir tu conocimiento? <br> Participa como speaker</h2>
				<div class="wow fadeInUp" data-wow-delay="300ms"><a class="btn btn-lg btn-common" href="cfp.html">Aplicar ahora</a></div>
				<a data-scroll href="#event">
				<div class="rev-scroll-btn wow fadeInUp" data-wow-delay="600ms">
					<span></span>
				</div>
