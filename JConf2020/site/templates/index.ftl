        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            ...
            <div class="carousel-caption">
              <h2 class="wow fadeInRight" data-wow-delay="300ms">JConf Guatemala 2020<br>10 years being the biggest Java Conference in Central America</h2>
    ...
    <section class="countdown-timer section">
        <div class="container">
          <div class="row">
            ...
            <div class="text">
            <h2>JConf Guatemala <br>2020</h2>
            <h4>Centro Tics Intecap <br> november 7, 2020 </h4>
            </div>
            </div>
