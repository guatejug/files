...
<div class="row">
	<div class="col-md-4 col-sm-4 col-xs-12">
		<div class="spnsors-logo wow fadeInUp" data-wow-delay="0.1s">
			...
			<#else>
				<img class="img-responsive center-block" src="<#if (content.rootpath)??>${content.rootpath}<#else></#if>img/post/duke2019.jpg" alt="" width="500px">
			</#if>
		</div>
	</div>
...
<div class="row">
	...
	<div id="share-buttons">
	    ...
	    <!-- Email -->
	    <a href="mailto:?Subject=Come to JConf 2019 ${content.uri}">
	        <img src="https://simplesharebuttons.com/images/somacro/email.png" alt="Email" />
	    </a>

	    <!-- Facebook -->
	    <a href="http://www.facebook.com/sharer.php?u=http://guate-jug.net/jconf2019/${content.uri}" target="_blank">
	        <img src="https://simplesharebuttons.com/images/somacro/facebook.png" alt="Facebook" />
	    </a>

	    <!-- Google+ -->
	    <a href="https://plus.google.com/share?url=http://guate-jug.net/jconf2019/${content.uri}" target="_blank">
	        <img src="https://simplesharebuttons.com/images/somacro/google.png" alt="Google" />
	    </a>

	    <!-- LinkedIn -->
	    <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://guate-jug.net/jconf2019/${content.uri}" target="_blank">
	    ...
	    <!-- Twitter -->
	    <a href="https://twitter.com/share?url=http://guate-jug.net/jconf2019/${content.uri};hashtags=jconf2019" target="_blank">
