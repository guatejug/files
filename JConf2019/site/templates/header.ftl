...
<html lang="en">
  <head>
    ...
    <title>JConf Guatemala 2019</title>
   ...
   <meta name="twitter:creator" content="@tuxtor">
    <meta name="twitter:image" content="http://guate-jug.net/jconf2019/img/post/${content.img}">
      ...
      <#else>
      	<meta name="twitter:card" value="JConf Guatemala 2019, the biggest JVM Event in Central America.">
      </#if>
      ...
      <#else>
      	<meta property="og:description" content="JConf Guatemala 2019, the biggest JVM Event in Central America." />
      </#if>
    <#else>
        <!-- Twitter Card data -->
        <meta name="twitter:site" content="@guatejug">
        <meta name="twitter:creator" content="@tuxtor">
        <meta name="twitter:image" content="http://guate-jug.net/jconf2019/img/globalheader.jpg">
            <#if (content.summary)??>
            <meta name="description" content="${content.summary}" />
              <meta name="twitter:card" value="${content.summary}">
            <#else>
            ...
            <!-- Open Graph data -->
            <meta property="og:title" content="JConf Guatemala 2019" />
            <meta property="og:type" content="article" />
            <meta property="og:image" content="http://guate-jug.net/jconf2019/img/globalheader.jpg" />
            <#if (content.summary)??>
              <meta property="og:description" content="${content.summary}" />
            <#else>
              <meta property="og:description" content="JConf Guatemala 2019, the biggest JVM Event in Central America." />
