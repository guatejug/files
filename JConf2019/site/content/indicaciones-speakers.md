...
Les agradecemos nuevamente su disposición para participar como expositores en JConf Guatemala 2019. A continuación les compartimos los primeros datos importantes.

## Horario designado

En el siguiente enlace encontraran el horario asignado a su presentación, por favor notificarnos si existe algún inconveniente.

http://guate-jug.net/jconf2019/archive.html
...
http://www.guate-jug.net/jconf2019/venue.html

Para los que se desplacen en automóvil el CENTRO TICS Intecap cuenta con estacionamiento para automóviles pequeños (sedan) y motocicletas, a un costo de Q10 ($1.10) todo el día. Sin embargo si su entrada fuera a partir de las 9 am el estacionamiento estará lleno por lo que les sugerimos estacionarse en el parqueo de en frente en la piscina olímpica, a un costo de Q40 el día ($5).

## Moneda y pagos

La moneda oficial en Guatemala es el Quetzal, cuyo tipo de cambio oscila entre Q 7.6 y Q 7.8 quetzales por un dolar.

Guatemala es uno de los países con mayor manejo de tarjeta de crédito en América Central, es posible adquirir bienes con tarjeta en montos a partir de los $4 dolares.
...
Como todo evento en Latinoamérica nuestra primer sugerencia es tomar las precauciones pertinentes para tener la mejor experiencia durante el evento.

La ciudad capital está dividida en zonas, que van desde la z1 hasta la z25. Las zonas consideradas seguras son:

* Zona 4 (donde se realizara el evento)
* Zona 9
* Zona 10
* Zona 13
* Zona 14
