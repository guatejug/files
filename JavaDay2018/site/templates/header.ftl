...
<html lang="en">
  <head>
   ...
   <meta name="twitter:creator" content="@tuxtor">
    <meta name="twitter:image" content="http://guate-jug.net/javaday2018/img/post/${content.img}">
      <#if (content.summary)??>
       <meta name="description" content="${content.summary}" />
      	<meta name="twitter:card" value="${content.summary}">
      <#else>
      	<meta name="twitter:card" value="Java Day 2018, the biggest Java Event in Central America.">
      </#if>

      <!-- Open Graph data -->
      <meta property="og:title" content="${content.title}" />
      <meta property="og:type" content="article" />
      <meta property="og:image" content="http://guate-jug.net/javaday2018/img/post/${content.img}" />
      <#if (content.summary)??>
      	<meta property="og:description" content="${content.summary}" />
      <#else>
      	<meta property="og:description" content="Java Day 2018, the biggest Java Event in Central America." />
      </#if>
    <#else>
