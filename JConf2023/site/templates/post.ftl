...
<div class="row">
	...
	<div id="share-buttons">
	    ...
	    <!-- LinkedIn -->
	    <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://guate-jug.net/jconf2023/${content.uri}" target="_blank">
	    ...
	    <!-- Twitter -->
	    <a href="https://twitter.com/share?url=http://guate-jug.net/jconf2023/${content.uri};hashtags=jconf2023" target="_blank">
